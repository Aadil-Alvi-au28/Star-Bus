                ...
                <table align="center">
                    <tr align="left">
                        <td align="left" class="style1">
                            <strong>
                                <asp:Label ID="lblheat" runat="server" Text="Contact Us" Font-Size="X-Large" ForeColor="#FF0000"></asp:Label></strong>
                            <br />
                        </td>
                    </tr>
                </table>
                                        ...
                                        <td valign="middle" colspan="4" height="40">
                                            <table cellspacing="0" cellpadding="2" width="93%" border="0">
                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="2" height="5">
                                                                            <p style="font-weight: bold; font-size: 18px; font-family: Verdana, Arial, Helvetica, sans-serif"
                                                                                ...
                                                                                <br />
                                                                                <br />
                                                                                <span style="font-size: 18px; font-family: Verdana, Arial, Helvetica, sans-serif"><br/>
                                                                                    <span style="font-weight: normal; font-size: 11px; line-height: 7mm; font-family: Verdana, Arial, Helvetica, sans-serif">
                                                                                        </span>Alvi Adil</span>
                                                                                  <span style="font-size: 18px; font-family: Verdana, Arial, Helvetica, sans-serif"><br/>
                                                                                    <span style="font-weight: normal; font-size: 11px; line-height: 7mm; font-family: Verdana, Arial, Helvetica, sans-serif">
                                                                                        Dongri market,<br />Near Sandhurst Road Railway Station,<br /> Mumbai</span></span>
                                                                            </p>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                    ...
                                                    <%--<tr valign="top" align="left">
                                                        <td>
                                                            <font size="3" color="#0066ff"><strong>Yusuf Pathan</strong> </font>
                                                        </td>
                                                        <td>
                                                            &nbsp;
                                                        </td>
