...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <asp:Login ID="Login1" runat="server" DisplayRememberMe="False" DestinationPageUrl="~/Secret/Selectseat.aspx"
        ...
        PasswordRecoveryUrl="~/Forget_password.aspx" BackColor="#F7F7DE" 
        BorderColor="#CCCC99" BorderStyle="Solid" BorderWidth="1px" 
        Font-Names="Verdana" Font-Size="10pt" 
        onauthenticate="Login1_Authenticate" CssClass="logininfo" >
        <LayoutTemplate>
                        ...
                        <table border="0" cellpadding="2">
                            <tr>
                                <td align="center" colspan="2" 
                                    style="color:White;background-color:#800000; font-size:1.1em;font-weight:bold;height:22px;">
                                    Log In</td>
                            </tr>
                            <tr>
...
<LabelStyle HorizontalAlign="Left"></LabelStyle>
        ...
        <TitleTextStyle BackColor="#6B696B"  Font-Bold="True" ForeColor="#FFFFFF" Height="22px" />
    </asp:Login>
    </div>
</asp:Content>
